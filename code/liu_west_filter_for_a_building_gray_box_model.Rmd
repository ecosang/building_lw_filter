...
```{r,eval=T,message=F,warining=F,error=F,fig.height=4.5,fig.width=10}
...
```{r,message=F,warining=F,error=F,eval=T,fig.width=8,fig.height=8,echo=F}
...
```{r,message=F,warining=F,error=F,fig.width=8,fig.height=8,echo=F}
