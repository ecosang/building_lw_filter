...
Visualize the filter results and compare with true paraemter values.
...
In this example, our major goal is to see the proposed method can be applicable in a 
